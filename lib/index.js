...
export class Maker {
   ...
   * @param {function(r: Maker): void} creator
   ...
   * @param {function(r: Maker): void} [creator=null] Scoped creator function
   * @since 0.9.0
  ...
  /**
   * @desc Configure your `resources('name', controller, options)` <br/> You can't use `except` and `only` at the same time
   ...
   * @return {void}
   * @throws {Error} "Crud should be named"
